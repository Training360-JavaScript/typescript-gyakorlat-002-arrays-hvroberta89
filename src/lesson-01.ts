export default class calculator {
    ...
    users: {name: string, email: string} [] = [
        {name: "Kiss János", email: "kiss.janos@gmail.com"},
        {name: "Nagy Franciska", email: "nagy.franc@gmail.com"}
    ];
    ...
    products : {name: string, price: number, stock: number, active?: boolean} [] = [
        {name: "Gloomhaven", price: 45500, stock: 5, active: true},
        {name: "Vast", price: 25990, stock: 2}
    ]
     ...
     */
    role: [number, string, boolean] = [0, "strategy", true];
